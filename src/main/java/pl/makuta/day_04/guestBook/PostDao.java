...
public class PostDao {
    ...
    private static final String CREATE_POST_QUERY = "INSERT INTO posts(title, decription) VALUES (?, ?)";
    private static final String FIND_ALL_POSTS_QUERY = "SELECT * FROM users";
